...
const ThemeSwithcer = () => {
  const activeStyles = "flex items-center justify-center w-5 h-5 rounded-full";
  ...
  return (
    <div className="flex h-8 w-14 items-center justify-around rounded-full bg-[#2e2f33]">
      <button
        className={`${activeStyles} ${theme === "light" ? "bg-white" : ""} `}
      ...
      <button
        className={`${activeStyles} ${theme === "dark" ? "bg-white" : ""} `}
